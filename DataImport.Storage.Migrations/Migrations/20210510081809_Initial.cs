        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchOne = table.Column<string>(nullable: true),
                    BranchTwo = table.Column<string>(nullable: true),
                    BranchThree = table.Column<string>(nullable: true),
                    BranchFour = table.Column<string>(nullable: true),
                    BranchFive = table.Column<string>(nullable: true),
                    BranchSix = table.Column<string>(nullable: true),
                    BranchSeven = table.Column<string>(nullable: true),
